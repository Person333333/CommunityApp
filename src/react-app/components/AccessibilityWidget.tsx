  ...
  return (
    <>
      <motion.button
        ...
        className="fixed bottom-24 right-6 w-16 h-16 bg-indigo-600 hover:bg-indigo-700 rounded-full flex items-center justify-center shadow-lg z-40 transition-colors"
