...
import { MapPin, Navigation, Phone, Globe, Layers, BarChart3 } from 'lucide-react';
...
export default function Map() {
  ...
  useEffect(() => {
    ...
    fetch('/api/resources')
      .then(res => res.json())
      .then(data => setResources(data.filter((r: ResourceType) => r.address)));
    ...
    if ('geolocation' in navigator) {
      navigator.geolocation.getCurrentPosition(
        ...
        (error) => {
          ...
          // Try to get approximate location from IP or use default
          // For now, keep default NYC coordinates
        },
        {
