      ...
      <div className="container mx-auto max-w-7xl">
        ...
        >
          ...
          <div className="flex items-center gap-2 sm:gap-4 mb-4 sm:mb-6">
            <div className="hidden sm:flex items-center gap-2 text-foreground font-black text-[10px] uppercase tracking-widest bg-card px-4 py-2 rounded-full border border-border shadow-sm">
              ...
              <div className="flex flex-col lg:flex-row gap-4 items-center">
                <div className="relative flex-1 group w-full">
                  ...
                  <Input
                    ...
                    className={`w-full bg-card border border-border rounded-xl ${searchTerm ? 'pl-20' : 'pl-12'} pr-32 py-7 text-foreground placeholder:text-muted-foreground/50 focus:outline-none focus:border-primary transition-all font-bold shadow-sm`}
                  />
                ...
                <div className="relative w-full lg:w-48 group" data-tour="zip-search">
                  ...
                  <Input
                    ...
                    className="w-full bg-card border border-border rounded-xl pl-12 py-7 text-foreground placeholder:text-muted-foreground/50 focus:outline-none focus:border-primary transition-all font-bold shadow-sm"
                  />
                </div>
              </div>
              ...
              <div className="flex flex-wrap gap-3 mt-2">
                ...
                <div className="relative" data-tour="category-explorer">
                  <select
                    ...
                    className="appearance-none pl-4 pr-10 py-2.5 bg-card border border-border rounded-none text-sm font-semibold text-foreground outline-none focus:border-emerald-500 transition-all disabled:opacity-50"
                  >
                    <option value="" className="bg-background">All Categories</option>
                    {categoryHierarchy.map(cat => <option key={cat.id} value={cat.label} className="bg-background">{cat.label}</option>)}
                  </select>
                ...
                <div className="relative">
                  <select
                    ...
                    className="appearance-none pl-4 pr-10 py-2.5 bg-card border border-border rounded-xl text-sm font-semibold text-foreground outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-500/20 cursor-pointer transition-all"
                  >
                    <option value="" className="bg-background">Any Cost</option>
                    <option value="free" className="bg-background">Free</option>
                    <option value="sliding" className="bg-background">Sliding Scale</option>
                  </select>
                ...
                <div className="flex gap-2 items-center ml-auto">
                  <Button
                    ...
                    className={`rounded-full px-4 py-2 font-black uppercase tracking-widest text-[10px] transition-all ${showFavoritesOnly ? 'bg-primary/20 text-primary border-primary/50' : 'bg-card text-foreground border-border hover:bg-card/80'}`}
                  >
                  ...
                  <Button
                    ...
                    className={`rounded-full px-4 py-2 font-black uppercase tracking-widest text-[10px] transition-all ${showMySubmissions ? 'bg-primary/20 text-primary border-primary/50' : 'bg-card text-foreground border-border hover:bg-card/80'}`}
                  >
